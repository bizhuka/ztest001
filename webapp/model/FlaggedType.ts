...
export default class FlaggedType extends SimpleType {
     ...
     */
    formatValue(iFlagged: number): boolean {
        //console.log(iFlagged)
        return iFlagged === 1;
    }
     ...
     */
    parseValue(bFlagged: boolean): number {
        console.warn(bFlagged)
        if (bFlagged) {
            return 1;
        }
